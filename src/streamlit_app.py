...
st.markdown("### Proyecto final - Data Science")
...
if boton_predecir:
    ...
    #cerificamos que no falten valores en las features
    ...
    if features_ultima_vela.isna().any():
        ...
        #el array de entrada para el modelo
    ...
    st.info("👈 Haz clic en **Predecir próxima vela** en el sidebar para obtener una predicción con los datos más recientes de Binance.")